...
;;;;
;;;; BUG/TODO: This file no longer seems to be used, but the contents
;;;; could probably be the base of some lovely unit tests. I'm
;;;; guessing that this kappa was taken from the unit test frame work
;;;; that I started in AmiGO, but never fully developed.
;;;;
...
(defparameter +data-directory+
  "/home/sjcarbon/local/src/svn/git/tanuki/data/")
